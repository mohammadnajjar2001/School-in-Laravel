                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-4">{{ trans('parent.father_role') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('profile.update.parent', $information->id) }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('parent.name_ar') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('parent.name_en') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('parent.password') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        ...
                                        <label class="form-check-label" for="exampleCheck1">
                                            {{ trans('parent.show_password') }}
                                        </label>
                                    </div>
                                </div>
                                <hr>
                                <button type="submit" class="btn btn-success">{{ trans('parent.edit_data') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
