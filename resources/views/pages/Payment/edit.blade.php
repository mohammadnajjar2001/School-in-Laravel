...
@section('css')
    @toastr_css
@section('title')
  {{ trans('Students_trans.edit_payment_voucher') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
@section('PageTitle')
    {{ trans('Students_trans.edit_payment_voucher') }} : <label style="color: red">{{ $payment_student->student->name }}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" rows="3">{{ $payment_student->description }}</textarea>
                            </div>
                        </div>
                    </div>
