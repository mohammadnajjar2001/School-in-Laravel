...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{ __('library.edit_book') }} : <span class="text-danger">{{$book->title}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">{{ __('library.grade') }} : <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Classroom_id">{{ __('library.classroom') }} : <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="section_id">{{ __('library.section') }} : </label>
