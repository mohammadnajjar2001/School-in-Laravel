                                                ...
                                                <td>
                                                    <a href="{{ route('Questions.create', ['quizze_id' => $quizze->id]) }}"
                                                       class="btn btn-warning btn-sm" role="button" aria-pressed="true">
                                                        <i class="fa fa-question-circle"></i> {{ trans('Quizzes.add_question') }}
                                                    </a>

                                                    <a href="{{ route('Quizzes.edit', $quizze->id) }}"
                                                       class="btn btn-info btn-sm" role="button" aria-pressed="true">
                                                       <i class="fa fa-edit"></i> {{ trans('Quizzes.edit') }}
                                                    </a>

                                                    <button type="button" class="btn btn-danger btn-sm"
                                                            data-toggle="modal"
                                                            data-target="#delete_exam{{ $quizze->id }}"
                                                            title="{{ trans('Quizzes.delete') }}">
                                                    ...
                                                    <form action="{{ route('Quizzes.destroy', 'test') }}" method="post">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>{{ trans('Quizzes.delete_warning') }} <b>{{ $quizze->name }}</b></p>
