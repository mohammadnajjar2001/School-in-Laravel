    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('Receipt.delete_receipt_title') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('receipt_students.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{ trans('Receipt.delete_receipt_message') }}</h5>
